...
public class PasswordPost {
    final static String TAG = "PasswordPost";
    final static String API = "https://bhpapi.herokuapp.com/api/";

    public static void resetPassword(final Context context, String link, final JSONObject body, final CourseRequest.VolleyCallback callback){
        ...
        })
        {
            ...
            public byte[] getBody() {
                ...
                try {
                    params2.put("email", body.getString("email"));
